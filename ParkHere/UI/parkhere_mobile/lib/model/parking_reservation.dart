...
class ParkingReservation {
  ...
  factory ParkingReservation.fromJson(Map<String, dynamic> json) {
      return ParkingReservation(
          ...
          startTime: DateTime.parse(json['startTime'] ?? json['StartTime']).toLocal(),
          ...
          createdAt: DateTime.parse(json['createdAt'] ?? json['CreatedAt'] ?? DateTime.now().toIso8601String()).toLocal(),
          ...
          arrivalTime: (json['arrivalTime'] ?? json['ArrivalTime']) != null ? DateTime.parse(json['arrivalTime'] ?? json['ArrivalTime']).toLocal() : null,
          actualStartTime: (json['actualStartTime'] ?? json['ActualStartTime']) != null ? DateTime.parse(json['actualStartTime'] ?? json['ActualStartTime']).toLocal() : null,
          actualEndTime: (json['actualEndTime'] ?? json['ActualEndTime']) != null ? DateTime.parse(json['actualEndTime'] ?? json['ActualEndTime']).toLocal() : null,
